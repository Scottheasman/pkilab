...
# PKI Lab - Issuing CA Setup Script (nyiss1 - New York)
# Run on the New York Issuing CA server
...
# 4. Manual Step: Submit the request file pkilab_issuing_ny.req to the Root CA for signing
Write-Host "Submit the request file C:\pkidata\pkilab_issuing_ny.req to the Root CA for signing."
...
# Example: C:\pkidata\pkilab_issuing_ny.cer
#
