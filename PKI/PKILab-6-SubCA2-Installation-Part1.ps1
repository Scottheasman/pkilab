## 7 - Install SubCA2 (Lab Issuing CA 2) - PART 1

### RUN THIS ENTIRE SCRIPT ON SUBCA2 SERVER (elevated PowerShell)
### This script configures SubCA2 and generates the certificate request.
...
Write-Host "   Location: C:\PKIData\subca2_request.req" -ForegroundColor Gray
...
Write-Host "   Action: Place the subca2_request.req file in the above folder." -ForegroundColor Gray
Write-Host "   Commands to run on Root CA:" -ForegroundColor Gray
Write-Host "   ---------------------------------------------------------------------------" -ForegroundColor Gray
Write-Host "   certreq -submit C:\PKIData\subca2_request.req C:\PKIData\subca2_issued.cer" -ForegroundColor Gray
Write-Host "   # If it goes pending:" -ForegroundColor Gray
Write-Host "   certutil -resubmit <REQUEST_ID>" -ForegroundColor Gray
Write-Host "   certreq -retrieve <REQUEST_ID> C:\PKIData\subca2_issued.cer" -ForegroundColor Gray
Write-Host "-----------------------------------------------------------------------------------------------------" -ForegroundColor Yellow
Write-Host "3. MANUALLY COPY ISSUED CERTIFICATE BACK TO SUBCA2:" -ForegroundColor Cyan
Write-Host "   Action: Copy C:\PKIData\subca2_issued.cer from Root CA to SubCA2 at:" -ForegroundColor Gray
Write-Host "   Location: C:\PKIData\subca2_issued.cer" -ForegroundColor Gray
Write-Host "-----------------------------------------------------------------------------------------------------" -ForegroundColor Yellow
Write-Host "4. COMPLETE SUBCA2 CONFIGURATION:" -ForegroundColor Cyan
Write-Host "   Action: After copying the issued certificate back, run PART 2 of this script on SubCA2." -ForegroundColor Gray
Write-Host "   File: Working-v2-7-SubCa2-Install-Part2.ps1" -ForegroundColor Gray
Write-Host "=====================================================================================================" -ForegroundColor Red
