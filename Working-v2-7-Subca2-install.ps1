...
# SubCA2 – Install AD CS Role & Generate Request
...
##
# copy the request file to C:\pkidata on CARoot1
certreq -submit C:\PKIData\subca2_request.req C:\PKIData\subca2_issued.cer
certutil -resubmit 3
certreq -retrieve 3 C:\PKIData\subca2_issued.cer
explorer.exe $LocalPkiFolder

# Copy c:\pkidata\subca2_issued.cer to subca2.lab.local c:\pkidata
certutil -installcert C:\PKIData\subca 2_issued.cer
...
# OCSP AIA: OCSP responder URL (embedded in issued certs)
Add-CAAuthorityInformationAccess `
    -Uri "$OcspHttpBase" `
...
# Publish initial CRL
certutil -CRL
# 6.7 SubCA2 – Publish Cert to AD and Copy to DFS
# Run on SubCA1:
# 
# powershell
# Copy
